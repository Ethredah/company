					...
					<div class="row">
						<div class="col-md-6 col-sm-6 col-lg-3">
							<div class="dash-widget clearfix card-box">
								<span class="dash-widget-icon"><i class="large material-icons">insert_chart</i></span>
						...
						<div class="col-md-6 col-sm-6 col-lg-3">
							<div class="dash-widget clearfix card-box">
								<span class="dash-widget-icon"><i class="large material-icons">card_travel</i></span>
								<div class="dash-widget-info">
									<h3>
                    23
                  </h3>
						...
						<div class="col-md-6 col-sm-6 col-lg-3">
							<div class="dash-widget clearfix card-box">
								<span class="dash-widget-icon"><i class="large material-icons">edit</i></span>
								<div class="dash-widget-info">
									<h3>4</h3>
						...
						<div class="col-md-6 col-sm-6 col-lg-3">
							<div class="dash-widget clearfix card-box">
								<span class="dash-widget-icon"><i class="large material-icons">face</i></span>
								<div class="dash-widget-info">
									<h3>18</h3>
									<span>Employees</span>
								</div>
