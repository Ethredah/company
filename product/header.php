    ...
    <body>
          ...
          <!----START OF HEADER AREA--->
            ...
            <div class="header">
                ...
                <div class="page-title-box pull-left">
					<h3><b>Poraeh Investments | Product Department</b> </h3>
                </div>
				<a id="mobile_btn" class="mobile_btn pull-left" href="#sidebar"><i class="fa fa-bars" aria-hidden="true"></i></a>
				<ul class="nav navbar-nav navbar-right user-menu pull-right">
					<li class="dropdown hidden-xs">
						<a href="#" class="dropdown-toggle" data-toggle="dropdown"><i class="large material-icons" style="color:yellow;">message</i <span class="badge bg-purple pull-right">3</span></a>
        ...
        <!----END OF HEADER AREA--->
            ...
            <div class="sidebar" id="sidebar">
              ...
              <li>
								<a href="activities.php">Complaints</a>
							</li>
