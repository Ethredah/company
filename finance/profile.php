            ...
            <!---- IF PROFILE = LOGGED = USER--->
					...
					<div class="card-box">
						<div class="row">
                          ...
                          <!-- <p>IF USER IS DIFFERENT FROM LOGGED IN PROFILE</p>
                          <div class="staff-msg"><a href="edit-profile.php?$empid" class="btn btn-custom">Edit Profile</a></div>
                          <p>IF USER IS DIFFERENT FROM LOGGED IN PROFILE</p> -->

													<div class="staff-msg"><a href="chat.php" class="btn btn-custom">Message</a></div>
												</div>
											</div>
											<div class="col-md-7">
