  ...
  ?>
            ...
            <div class="page-wrapper">
                <div class="content container-fluid">
					<div class="row">
						<div class="col-md-4">
							<h4 class="page-title"><b>Client Profile</b></h4>
						</div>

            <div class="col-md-3">
              <div class="dash-widget clearfix card-box">
            <div class="dash-widget-info" style="color: #de482a ;">
              <h3>1</h3>
              <span>Projects</span>
            </div>
          </div>
          ...
          <div class="col-md-4">
            <div class="dash-widget clearfix card-box">
            <div class="dash-widget-info" style="color: #2adea7 ;">
              <h3>$12,780</h3>
              <span>Payments</span>
            </div>
          </div>
                        ...
                        <div class="table-responsive">
                          <table class="table table-striped custom-table datatable">
                            ...
                            <tbody>
                              ...
                              <tr>
                                <td>
                                  <h2><a href="project-view.php">Sales Training</a></h2>
                                </td>
